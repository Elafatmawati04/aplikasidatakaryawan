...
<body>
     ...
     <div class="container">
        <div class="mt-3">
             <h3 class="text-center">Absensi Data Karyawan</h3>
        </div>
           ...
           <div class="card-body">
                ...
                <button type="button" class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#modalTambah">
                 ...
                 <table class="table table-bordered table-striped table-hover">
                    ...
                    $no = 1;
                    $tampil = mysqli_query($conn, "SELECT * FROM absensi ORDER BY id DESC");
                              ...
                              <div class="modal-header">
                               ...
                               <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                             ...
                                             <input type="text" class="form-control" name="tfhari"  value="<?= $data['hari']?>" placeholder="Masukkan Hari">
                                        </div>
                                        <div class="mb-3">
                                             <label class="form-label">Shift</label>
                                             <select class="from-select" name="tfsift">
                                                  <option value="<?= $data['sift']?>"><?= $data['sift']?></option>
                                        ...
                                        <div class="mb-3">
                                             ...
                                             <input type="text" class="form-control" name="tfbagian" value="<?= $data['bagian']?>" placeholder="Masukkan Bagian Anda">
                                        </div>
                   ...
                   <div class="modal-dialog">
                      <div class="modal-content">
                          ...
                          <div class="modal-body">
                                   ...
                                   <div class="mb-3">
                                      <label class="form-label">Hari</label>
                                       <input type="text" class="form-control" name="tfhari" placeholder="Masukkan Hari">
                                   </div>
                                   <div class="mb-3">
                                      <label class="form-label">Shift</label>
                                      <select class="from-select" name="tfsift">
                                  ...
                                  <div class="mb-3">
                                       <label  class="form-label">Bagian</label>
                                       <input type="text" class="form-control" name="tfbagian" placeholder="Masukkan Bagian">
                                  </div>
